...
Write-Host "`n=== 2/3 flutter test (unit + widget) ===" -ForegroundColor Cyan
flutter test
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

Write-Host "`n=== 3/3 flutter test integration_test/app_test.dart -d $AndroidDeviceId ===" -ForegroundColor Cyan
