...
class ContentOrderStockAdjustmentRegisterEditItem extends StatefulWidget {
  const ContentOrderStockAdjustmentRegisterEditItem({
    Key? key,
  }) : super(key: key);

  @override
  State<ContentOrderStockAdjustmentRegisterEditItem> createState() =>
      _ContentOrderStockAdjustmentRegisterEditItemState();
}

class _ContentOrderStockAdjustmentRegisterEditItemState
    extends State<ContentOrderStockAdjustmentRegisterEditItem> {
