...
class OrderStockAdjustmentRegisterRepositoryImpl implements OrderStockAdjustmentRegisterRepository {
  ...
  @override
  Future<Either<Failure, List<EntityModel>>> getListEntities() async {
    try {
