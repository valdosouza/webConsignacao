...
class ContentLineBusinessRegisterDesktop extends StatefulWidget {
  const ContentLineBusinessRegisterDesktop({super.key});

  @override
  State<ContentLineBusinessRegisterDesktop> createState() =>
      _ContentLineBusinessRegisterDesktopState();
}

class _ContentLineBusinessRegisterDesktopState
    extends State<ContentLineBusinessRegisterDesktop> {
