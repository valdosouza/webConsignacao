...
class ContentTabDetail extends StatefulWidget {
  const ContentTabDetail({
    Key? key,
  }) : super(key: key);

  @override
  State<ContentTabDetail> createState() => ContentTabDetailState();
}

class ContentTabDetailState extends State<ContentTabDetail> {
