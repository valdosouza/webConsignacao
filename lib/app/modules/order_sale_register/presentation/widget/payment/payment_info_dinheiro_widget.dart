...
Widget paymentinfodinheiro(OrderSaleMainCardModel modelOrderSale) {
  return Row(
    children: [
      Expanded(
        flex: 5,
        ...
        child: Container(
          ...
          child: TextField(
            controller: TextEditingController(
                text: modelOrderSale.payments[0].value.toStringAsFixed(2)),
            keyboardType: TextInputType.number,
            textAlign: TextAlign.right,
            onSubmitted: (value) {
              modelOrderSale.payments[0].value = double.parse(value);
            },
          ),
        ),
      ),
