...
import 'package:appweb/app/modules/order_sale_register/presentation/content/content_order_sale_register_detail.dart';
import 'package:appweb/app/modules/order_sale_register/presentation/content/content_sale_register_master.dart';
...
class ContentOrderSaleRegisterDesktop extends StatefulWidget {
  final int tabIndex;
  const ContentOrderSaleRegisterDesktop({Key? key, this.tabIndex = 0})
      : super(key: key);

  @override
  State<ContentOrderSaleRegisterDesktop> createState() =>
      _ContentOrderSaleRegisterDesktopState();
}

class _ContentOrderSaleRegisterDesktopState
    extends State<ContentOrderSaleRegisterDesktop>
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: BlocConsumer<OrderSaleRegisterBloc, OrderSaleRegisterState>(
        bloc: bloc,
        ...
        builder: (context, state) {
          return Scaffold(
            ...
            body: TabBarView(
              controller: _tabController,
              children: const [
                ContentOrderSaleRegisterMaster(),
                ContentOrderSaleRegisterDetail(),
              ],
            ),
