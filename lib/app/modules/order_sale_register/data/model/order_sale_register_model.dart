...
import 'package:appweb/app/modules/order_sale_register/domain/entity/order_sale_register_entity.dart';

class OrderSaleRegisterModel extends OrderSaleRegisterEntity {
  OrderSaleRegisterModel({
    int? id,
    int? tbInstitutionId,
    int? tbUserId,
    int? tbEntityId,
    ...
    List<OrderSaleRegisterItemsModel>? items,
          ...
          status: status ?? "",
          items:
              items ?? List<OrderSaleRegisterItemsModel>.empty(growable: true),
        );

  factory OrderSaleRegisterModel.fromJson(Map<String, dynamic> json) {
    return OrderSaleRegisterModel(
        ...
        items: json['items'] == null
            ? null
            : (json['items'] as List)
                .map((e) => OrderSaleRegisterItemsModel.fromJson(e))
                .toList());
  }
  ...
  factory OrderSaleRegisterModel.empty() {
    return OrderSaleRegisterModel(
