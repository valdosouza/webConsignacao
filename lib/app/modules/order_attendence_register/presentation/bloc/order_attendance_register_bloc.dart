  ...
  attendancePost() {
    on<OrderAttendanceRegisterPostEvent>((event, emit) async {
      ...
      final result = response.fold((l) {
        ...
        //este items não sao enviados para o post e retornam vazios
        //int tbUserId;
        String nameCustomer = orderAttendance.nameCustomer;
        //int tbSalesmanId;
        String nameSalesman = orderAttendance.nameSalesman;
        //int tbPriceListId;
        String routeRetorn = orderAttendance.routeRetorn;
        int tbSalesRouteId = orderAttendance.tbSalesRouteId;
        String nameSalesRoute = orderAttendance.nameSalesRoute;
        int tbRegionId = orderAttendance.tbRegionId;
        String nameRegion = orderAttendance.nameRegion;
        //Aqui pega o retorno do post
        orderAttendance = r;
        //Depois do post precisamos setar estes campos novamentes
        orderAttendance.nameCustomer = nameCustomer;
        //int tbSalesmanId;
        orderAttendance.nameSalesman = nameSalesman;
        //int tbPriceListId;
        orderAttendance.routeRetorn = routeRetorn;
        orderAttendance.tbSalesRouteId = tbSalesRouteId;
        orderAttendance.nameSalesRoute = nameSalesRoute;
        orderAttendance.tbRegionId = tbRegionId;
        orderAttendance.nameRegion = nameRegion;
