...
class ContentMobileCustomerRegister extends StatefulWidget {
  const ContentMobileCustomerRegister({super.key});

  @override
  State<ContentMobileCustomerRegister> createState() =>
      _ContentMobileCustomerRegisterState();
}

class _ContentMobileCustomerRegisterState
    extends State<ContentMobileCustomerRegister> {
