...
class CashierClosurePageDesktop extends StatefulWidget {
  const CashierClosurePageDesktop({super.key});

  @override
  State<CashierClosurePageDesktop> createState() =>
      CashierClosurePageDesktopState();
}

class CashierClosurePageDesktopState extends State<CashierClosurePageDesktop> {
  @override
  void initState() {
    super.initState();
