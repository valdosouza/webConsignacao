...
class PaymentRepositoryImpl implements PaymentRepository {
  ...
  @override
  Future<Either<Failure, List<PaymentModel>>> getList({required int institutionId}) async {
    try {
  ...
  @override
  Future<Either<Failure, String>> deletePayment({required int paymentId}) async {
    try {
      final result = await paymentDataSource.deletePayment(paymentId: paymentId);
      return Right(result);
    } catch (e) {
      return Left(ServerFailure());
    }
  ...
  @override
  Future<Either<Failure, String>> putPayment({required PaymentModel paymentModel}) async {
    try {
      final result = await paymentDataSource.putPayment(paymentModel: paymentModel);
      return Right(result);
    } catch (e) {
      return Left(ServerFailure());
    }
